...
(function(){
    ...
    exports.connect = function(destinationUrl, options) {
        ...
        options = options || {};
        options['forceNew'] = true;   // Allows one tunnel server to handle multiple destinations
        console.log('WSS connection: '+'http://localhost:' + tunnelPort + pathname +
    ...
    exports.init = function(proxyUrl) {
        ...
        console.log('WSS proxy set to ' + proxyUrl);
    };
})();
